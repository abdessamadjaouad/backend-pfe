package  ma.zs.GestionAgents.ws.facade.utilisateur.BioManager;
...
@RestController
@RequestMapping("/api/utilisateur/badgeNfc/")
public class BadgeNfcRestUtilisateur {
    ...
    @Autowired private BadgeNfcUtilisateurService service;

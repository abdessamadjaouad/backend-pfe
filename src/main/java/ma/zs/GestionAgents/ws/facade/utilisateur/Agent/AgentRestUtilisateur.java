package  ma.zs.GestionAgents.ws.facade.utilisateur.Agent;
...
@RestController
@RequestMapping("/api/utilisateur/agent/")
public class AgentRestUtilisateur {
    ...
    @Autowired private AgentUtilisateurService service;

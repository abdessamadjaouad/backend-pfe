package  ma.zs.GestionAgents.ws.facade.admin.Service;
...
import ma.zs.GestionAgents.service.facade.admin.Service.EntiteAdministrativeAdminService;
...
public class EntiteAdministrativeRestAdmin {
    ...
    @Operation(summary = "find by chefService id")
    @GetMapping("chefService/id/{id}")
    public List<EntiteAdministrativeDto> findByChefServiceId(@PathVariable Long id){
        return findDtos(service.findByChefServiceId(id));
    }
    @Operation(summary = "delete by chefService id")
    @DeleteMapping("chefService/id/{id}")
    public int deleteByChefServiceId(@PathVariable Long id){
        return service.deleteByChefServiceId(id);
    }

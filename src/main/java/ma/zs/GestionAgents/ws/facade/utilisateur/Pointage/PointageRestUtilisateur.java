package  ma.zs.GestionAgents.ws.facade.utilisateur.Pointage;
...
@RestController
@RequestMapping("/api/utilisateur/pointage/")
public class PointageRestUtilisateur {
    ...
    @Autowired private PointageUtilisateurService service;

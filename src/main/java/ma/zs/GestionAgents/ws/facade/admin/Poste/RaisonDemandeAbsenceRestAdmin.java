package  ma.zs.GestionAgents.ws.facade.admin.Poste;
...
@RestController
@RequestMapping("/api/admin/raisonDemandeAbsence/")
public class RaisonDemandeAbsenceRestAdmin {
    ...
    @Autowired private RaisonDemandeAbsenceAdminService service;

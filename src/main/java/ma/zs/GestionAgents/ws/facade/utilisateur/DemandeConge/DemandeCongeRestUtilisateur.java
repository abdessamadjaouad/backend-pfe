package  ma.zs.GestionAgents.ws.facade.utilisateur.DemandeConge;
...
@RestController
@RequestMapping("/api/utilisateur/demandeConge/")
public class DemandeCongeRestUtilisateur {
    ...
    @Autowired private DemandeCongeUtilisateurService service;

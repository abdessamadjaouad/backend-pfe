package ma.zs.GestionAgents.zynerator.security.common;
...
import ma.zs.GestionAgents.GestionAgentsApplication;
...
public class SecurityUtil {
    ...
    public static User getCurrentUser() {
        UserService userService= GestionAgentsApplication.getCtx().getBean(UserService.class);

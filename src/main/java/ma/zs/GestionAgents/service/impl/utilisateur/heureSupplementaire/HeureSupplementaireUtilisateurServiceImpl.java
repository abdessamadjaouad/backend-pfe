package ma.zs.GestionAgents.service.impl.utilisateur.heureSupplementaire;
...
import java.util.List;
@Service
public class HeureSupplementaireUtilisateurServiceImpl implements HeureSupplementaireUtilisateurService {
